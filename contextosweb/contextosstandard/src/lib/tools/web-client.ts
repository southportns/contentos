/**
 * Web Client — Firecrawl Search & Scrape
 *
 * Standard version: uses Firecrawl for web research. Requires FIRECRAWL_API_KEY.
 * - Search: Firecrawl Search API
 * - Scrape: Firecrawl Scrape API (markdown + html)
 */
