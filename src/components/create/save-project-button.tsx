...
interface SaveProjectButtonProps {
  ...
  originalDraft?: WritingDraft | null
  humanization?: HumanizationState | null
      ...
      const res = await fetch('/api/projects/save', {
        ...
        body: JSON.stringify({
          ...
          refineData: refineData
            ? {
                content: refineData.content,
                title: refineData.title,
                hook: refineData.hook,
                wordCount: refineData.wordCount,
                changes: refineData.changes,
                hookCandidates: refineData.hookCandidates,
                titleCandidates: refineData.titleCandidates,
                summary: refineData.summary,
                resolvedIssues: refineData.resolvedIssues,
                unresolvedIssues: refineData.unresolvedIssues,
                preservedElements: refineData.preservedElements,
              }
            : undefined,
          humanization: humanization
            ? {
                adopted: humanization.adopted,
                result: humanization.result,
              }
            : undefined,
          refineIssues: refineIssues,
