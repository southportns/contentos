...
export const topicRepository = {
  ...
  async createManualEditDraft(params: {
    ...
    // P0.5.1 Fix — Stale Active Draft Protection:
    // Verify sourceDraft is still the active draft. If activeDraftId has changed
    // (e.g., another tab saved a new draft), refuse to overwrite.
