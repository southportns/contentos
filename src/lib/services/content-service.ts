...
export const contentService = {
  ...
  async archiveContent(
    ...
    return profileRepository.createArchive({
      ...
      finalHook: data.finalHook,
      refineChanges: data.refineChanges as Prisma.InputJsonValue | undefined,
      refineData: data.refineData as Prisma.InputJsonValue | undefined,
      humanizationData: data.humanizationData as Prisma.InputJsonValue | undefined,
      humanizationAdopted: data.humanizationAdopted,
      resolvedIssues: data.resolvedIssues as Prisma.InputJsonValue | undefined,
      unresolvedIssues: data.unresolvedIssues as Prisma.InputJsonValue | undefined,
      preservedElements: data.preservedElements as Prisma.InputJsonValue | undefined,
      draftVersion: data.draftVersion,
      refineVersion: data.refineVersion,
      selectedAngleTitle: data.selectedAngleTitle,
      strategyTone: data.strategyTone,
