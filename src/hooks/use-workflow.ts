...
export const workflowActions = {
  ...
  dismissHumanization: () =>
    setState((prev) => ({
      ...prev,
      humanization: { ...prev.humanization, status: 'idle', result: null, adopted: false },
    })),
...
/** @internal test-only getter for production workflow state */
export const getWorkflowStateForTest = () => state
