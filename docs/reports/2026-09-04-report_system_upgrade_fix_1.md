...
- **Generated At**: 2026-09-04T05:35:57.316Z
- **Branch**: main
...
[1m[46m RUN [49m[22m [36mv3.2.7 [39m[90mD:/Project/contextos[39m
 ...
 [32m✓[39m src/knowledge/semantic/providers/__tests__/aliyun-embedding-provider.test.ts [2m([22m[2m34 tests[22m[2m)[22m[32m 222[2mms[22m[39m
 [32m✓[39m src/knowledge/semantic/__tests__/semantic-retriever.test.ts [2m([22m[2m18 tests[22m[2m)[22m[32m 142[2mms[22m[39m
 [32m✓[39m src/knowledge/__tests__/knowledge-ranker.test.ts [2m([22m[2m19 tests[22m[2m)[22m[32m 104[2mms[22m[39m
 [32m✓[39m scripts/__tests__/generate-report.test.ts [2m([22m[2m42 tests[22m[2m)[22m[32m 54[2mms[22m[39m
 [32m✓[39m src/knowledge/semantic/__tests__/similarity.test.ts [2m([22m[2m20 tests[22m[2m)[22m[32m 32[2mms[22m[39m
 [32m✓[39m src/knowledge/__tests__/knowledge-store.test.ts [2m([22m[2m25 tests[22m[2m)[22m[32m 49[2mms[22m[39m
 [32m✓[39m .next/standalone/scripts/evaluate-knowledge-retrieval.test.ts [2m([22m[2m10 tests[22m[2m)[22m[32m 15[2mms[22m[39m
 [32m✓[39m tests/expression/prompt-builder.test.ts [2m([22m[2m10 tests[22m[2m)[22m[32m 17[2mms[22m[39m
 [32m✓[39m .next/standalone/tests/expression/prompt-builder.test.ts [2m([22m[2m10 tests[22m[2m)[22m[32m 18[2mms[22m[39m
 [32m✓[39m tests/expression/audit-logic.test.ts [2m([22m[2m11 tests[22m[2m)[22m[32m 10[2mms[22m[39m
 [32m✓[39m scripts/evaluate-knowledge-retrieval.test.ts [2m([22m[2m10 tests[22m[2m)[22m[32m 16[2mms[22m[39m
 [32m✓[39m .next/standalone/tests/expression/audit-logic.test.ts [2m([22m[2m11 tests[22m[2m)[22m[32m 11[2mms[22m[39m
 [32m✓[39m tests/expression/schema.test.ts [2m([22m[2m23 tests[22m[2m)[22m[32m 48[2mms[22m[39m
 [32m✓[39m .next/standalone/tests/expression/schema.test.ts [2m([22m[2m23 tests[22m[2m)[22m[32m 52[2mms[22m[39m
 [32m✓[39m tests/expression/workflow-regression.test.ts [2m([22m[2m23 tests[22m[2m)[22m[33m 4273[2mms[22m[39m
   [33m[2m✓[22m[39m Expression Engine Skills — Module Imports[2m > [22mshould be able to import expression-planning skill [33m 4054[2mms[22m[39m
 [32m✓[39m .next/standalone/tests/expression/workflow-regression.test.ts [2m([22m[2m23 tests[22m[2m)[22m[33m 4263[2mms[22m[39m
   [33m[2m✓[22m[39m Expression Engine Skills — Module Imports[2m > [22mshould be able to import expression-planning skill [33m 4043[2mms[22m[39m

[2m Test Files [22m [1m[32m17 passed[39m[22m[90m (17)[39m
[2m      Tests [22m [1m[32m326 passed[39m[22m[90m (326)[39m
[2m   Start at [22m 13:36:03
[2m   Duration [22m 9.22s[2m (transform 2.22s, setup 0ms, collect 8.98s, tests 9.36s, environment 12ms, prepare 11.47s)[22m
...
```
erated from standalone (copied via extraResources)
...
✓ Generating static pages using 7 workers (59/59) in 1662ms
